 ...
 * in @entry an element you know is on @head.  @list
 */
...
static inline void __list_splice(const struct list_head *list,
                                 ...
                                 struct list_head *next)
{ 
  /* ignore struct list_head *first = list->next; */
  prev->next = list->next;
  prev->next->prev = prev;
  /* ignore struct list_head *last = list->prev; */
  next->prev = list->prev;
  next->prev->next = next;
}
 ...
 *
 * @ptr is @member pointer variable which type within container type.
 * @type is container struct type.
 * @member is name of type, which is same as ptr type within container type.
 * return the address of container with (@type *).
 */
...
#define list_for_each_entry_continue_reverse(pos, head, member)  \
  for (pos = list_prev_entry(pos, head, member);                 \
       &(pos)->member != (head);                                 \
       pos = list_prev_entry(pos, head, member))
 ...
 * @member: the name of the list_head within the struct.
 *
 * Iterate backwards over list of given type, continung from current position.
 */
...
#define list_for_each_entry_safe(pos, n, head, member)       \
  for (pos = list_first_entry(pos, typeof(*(pos)), member),  \
 ...
 * @member: the name of the list_head within the struct.
 *
 * Iterate backwards over list of given type, safe against removal of lit
 * entry.
 */
