...
#define CANBYPASSIF_NUMBER_OF_PDU   (CANBYPASSIFRX_TOTAL_NUM + CANBYPASSIFTX_TOTAL_NUM)
/*****************************************************************************
...
{
    {
        CANIF_RECEIVE, CANIF_STANDARD, HANDLE_CAN0_RX0, CANIF_PHY_M_RX_CANID
    },
    {
        CANIF_RECEIVE, CANIF_STANDARD, HANDLE_CAN0_RX0, CANIF_FUN_RX_CANID
    },
    {
        CANIF_TRANSMITE, CANIF_STANDARD, HANDLE_CAN0_TX0,CANIF_PHY_M_TX_CANID
    },
};
#else
