...
{
    {
        0xF180u, 0, DCM_22DID_MINLEN, 16,
        DCM_22DID_FLAG,BL_NULL_PTR, BL_NULL_PTR,
        &Adpt_UdsCallbackReadF180
    },
    {	/*TesterSerialNumber*/
        0xF198u, 0, DCM_22DID_MINLEN, 10,
        DCM_22DID_FLAG,BL_NULL_PTR, BL_NULL_PTR,
        &Adpt_UdsCallbackReadF198
    },
    {	/*ProgrammingDate*/
        0xF199u, 0, DCM_22DID_MINLEN, 4,
        DCM_22DID_FLAG,BL_NULL_PTR, BL_NULL_PTR,
        &Adpt_UdsCallbackReadF199
    }
};
...
{
    {
        1, 0, DCM_27SEED_MINLEN, 2, DCM_27SUBIDSEED_FLAG,
        BL_NULL_PTR, BL_NULL_PTR, &Adpt_UdsCallbackGetSeedForLevel1
    },
    {
        2, 0, DCM_27KEY_MINLEN, 6, DCM_27SUBIDKEY_FLAG,
...
{
    {	/*TesterSerialNumber*/
        0xF198u, 0, DCM_2EFINGERPRINT_MINLEN, 13,
        DCM_2EDID_FLAG,BL_NULL_PTR, BL_NULL_PTR,
        &Adpt_UdsCallbackWriteF198
    },
    {	/*ProgrammingDate*/
        0xF199u, 0, DCM_2EPROGRAMDATE_MINLEN, 7,
        DCM_2EDID_FLAG,BL_NULL_PTR, BL_NULL_PTR,
        &Adpt_UdsCallbackWriteF199
    }
};
...
{
    {
        0, 0, DCM_28SERVICE_MINLEN, 3, 0, BL_NULL_PTR, BL_NULL_PTR, &Adpt_UdsCallback28
    },
    {
        3, 0, DCM_28SERVICE_MINLEN, 3, 0, BL_NULL_PTR, BL_NULL_PTR, &Adpt_UdsCallback28
    },
};
/**************************************************************************//**
...
{
	{
		0x0202u, 0, DCM_31CHECKSUM_MINLEN, 4, DCM_31CHECKSUM_FLAG,
