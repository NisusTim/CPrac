...
#define LBM_LB0_WRITE_MASK 			(0x00000000UL)
#define LBM_LB0_ERASE_MASK          (0x00000000UL)
#define LBM_LB0_VERIFY_MASK         (0x00000000UL)
#define LBM_LB0_ADDRESS             (0x00FB0000UL)
#define LBM_LB0_SIZE                (0x001CFFE0UL)
#define LBM_LB0_OFFSET_MASK         (0x0FFFFFFFUL)
#define LBM_LB0_VALID_FLAG_ID       (0x02u)
#define LBM_LB0_FILE_HEADER_ID      (0x06u)
#define LBM_LB0_FINGERPRINT_ID      (0x03u)
...
#define LBM_LB1_TYPE                LBM_TYPE_CALDATA
#define LBM_LB1_INDEX               (0u)
#define LBM_LB1_STATUS_PTR          (&gs_LogicalBlockStatus[1])
#define LBM_LB1_MEMID               (2u)
#define LBM_LB1_GETID_MASK          (0x00000000UL)
//#define LBM_LB1_WRITE_MASK          RTE_SYSFLAG_ERASE_BLOCK
#define LBM_LB1_WRITE_MASK 			(0x00000000UL)
#define LBM_LB1_ERASE_MASK          (0x00000000UL)
#define LBM_LB1_VERIFY_MASK         (0x00000000UL)
#define LBM_LB1_ADDRESS             (0x0080C000UL)
#define LBM_LB1_SIZE                (0x00004000UL)
#define LBM_LB1_OFFSET_MASK         (0x00FFFFFFUL)
#define LBM_LB1_VALID_FLAG_ID       (0x04u)
#define LBM_LB1_FILE_HEADER_ID      DM_ERROR_DATAID
#define LBM_LB1_FINGERPRINT_ID      (0x05u)
...
#define LBM_LB2_INDEX               (0)
#define LBM_LB2_STATUS_PTR          (&gs_LogicalBlockStatus[2])
#define LBM_LB2_MEMID               (0)
...
#define LBM_LB2_ADDRESS             (0x40000000UL)
#define LBM_LB2_SIZE                (0x00001800UL)
#define LBM_LB2_OFFSET_MASK         (0xFFFFFFFFUL)
#define LBM_LB2_VALID_FLAG_ID       DM_ERROR_DATAID
