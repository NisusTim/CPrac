...
/** \brief */
#define RTE_FUN_RST_RSP_IN_BT       BL_FUN_OFF
/** \brief */
...
/** \brief */
#define RTE_BOOTLOADER_TYPE   					BL_TYPE_MASTER
...
#define RTE_FINGERPRINT_F15B_SIZE           (20UL)
#define RTE_LATEST_UPDATED_BLOCK_SIZE       (1UL)
#define RTE_FILEHEADER_SIZE                 (8UL)

#define RTE_WATCHDOG_FEED_INTERFACE_ADDR    (0x3DE0U)
