...
#define SECM_ACCESS_INIT            (&Acc_UdsInit)
#define SECM_ACCESS_MAKE_NEWSEED    (&Acc_UdsMakeNewSeed)
#define SECM_ACCESS_GET_SEED        (&Acc_UdsGetSeed)
#define SECM_ACCESS_VERIFY_KEY      (&Acc_UdsVerifyKey)
