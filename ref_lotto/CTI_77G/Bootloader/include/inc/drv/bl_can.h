...
extern bl_u32_t g_dummy_for_security;
...
extern bl_u32_t Can_GetUdsPhysicalRequestId(void);
extern bl_u32_t Can_GetUdsPhysicalResponseId(void);
extern void Can_SetUdsPhysicalRequestId(bl_u32_t canid);
extern void Can_SetUdsPhysicalResponseId(bl_u32_t canid);
#endif
