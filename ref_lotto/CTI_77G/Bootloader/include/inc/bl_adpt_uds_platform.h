...
/** \brief Callback of reading F187.*/
extern bl_ResponseCode_t Adpt_UdsCallbackReadF187(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
/** \brief Callback of reading F193.*/
extern bl_ResponseCode_t Adpt_UdsCallbackReadF193(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
/** \brief Callback of reading F18C.*/
extern bl_ResponseCode_t Adpt_UdsCallbackReadF18C(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);

extern bl_ResponseCode_t Adpt_UdsCallbackReadF180(bl_BufferSize_t size,
												  bl_Buffer_t *buffer,
												  bl_BufferSize_t *respSize);
/** \brief Callback of reading F198.*/
extern bl_ResponseCode_t Adpt_UdsCallbackReadF198(bl_BufferSize_t size,
                                                     bl_Buffer_t *buffer,
                                                     bl_BufferSize_t *respSize);
/** \brief Callback of reading F199.*/
extern bl_ResponseCode_t Adpt_UdsCallbackReadF199(bl_BufferSize_t size,
												  bl_Buffer_t *buffer,
												  bl_BufferSize_t *respSize);

/** \brief Callback of Write F190.*/
extern bl_ResponseCode_t Adpt_UdsCallbackWriteF190(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
...
extern bl_ResponseCode_t Adpt_UdsCallback28(bl_BufferSize_t size,
                                              bl_Buffer_t *buffer,
                                              bl_BufferSize_t *respSize);
/** \brief Callback of writting F198.*/
extern bl_ResponseCode_t Adpt_UdsCallbackWriteF198(bl_BufferSize_t size,
                                                     bl_Buffer_t *buffer,
                                                     bl_BufferSize_t *respSize);
/** \brief Callback of writting F199.*/
extern bl_ResponseCode_t Adpt_UdsCallbackWriteF199(bl_BufferSize_t size,
                                                     bl_Buffer_t *buffer,
                                                     bl_BufferSize_t *respSize);
