...
struct _tag_FlashDrvParam
{
    ...
    bl_u32_t	fs8x_wd_ftime;	/**< the pmic fs8x feed watchdog timestamp*/
    void (*FeedDog)(void);  	/**< the feed watchdog interface.*/
    void (*Fs8xFeedDog)(void); /**< the pmic fs8x feed watchdog interface*/
};
...
typedef enum
{
    FlsDriverStatus_UInit = 0,
    FlsDriverStatus_Init = 1
}FlsDriverStatusType;
