///////////////////////////////////////////////////////////////////////////////////////////////////
// 嚙� NXP B.V. 2013. All rights reserved.
// Disclaimer
...
// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t InitTJA1145(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t CheckFsmStatus(void); 

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t ChangeToSleepOperation(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t ChangeToStandbyOperation(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t ChangeToNormalOperation(void);        

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t EventHandling(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t RxdLowHandling(void);
...
// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t ConfigurePartialNetworking(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_SPIF_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_OTW_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_PO_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_PNFDE_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_CW_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_CF_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_CBS_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_WPF_ServiceRoutine(void);

// see TJA1145_Application_Specific_Functions.c for documentation
StdRet_t TJA1145_WPR_ServiceRoutine(void);
