...
Word TJA1145FD_CAN_ID_MASK = 0x0001;  
...
TJA1145FD_Data_Mask_0_Config_t TJA1145FD_CAN_DATA_MASK0 = 0xFF;	//00	// 1st byte on the bus; if DLC = 1, last byte on the bus
TJA1145FD_Data_Mask_1_Config_t TJA1145FD_CAN_DATA_MASK1 = 0xFF;	//10	// 2nd byte on the bus; if DLC = 2, last byte on the bus
TJA1145FD_Data_Mask_2_Config_t TJA1145FD_CAN_DATA_MASK2 = 0xFF;	//00	// 3rd byte on the bus; if DLC = 3, last byte on the bus
TJA1145FD_Data_Mask_3_Config_t TJA1145FD_CAN_DATA_MASK3 = 0xFF;	//00	// 4th byte on the bus; if DLC = 4, last byte on the bus
TJA1145FD_Data_Mask_4_Config_t TJA1145FD_CAN_DATA_MASK4 = 0xFF;	//00	// 5th byte on the bus; if DLC = 5, last byte on the bus
TJA1145FD_Data_Mask_5_Config_t TJA1145FD_CAN_DATA_MASK5 = 0xFF;	//00	// 6th byte on the bus; if DLC = 6, last byte on the bus
TJA1145FD_Data_Mask_6_Config_t TJA1145FD_CAN_DATA_MASK6 = 0xFF;	//00	// 7th byte on the bus; if DLC = 7, last byte on the bus
TJA1145FD_Data_Mask_7_Config_t TJA1145FD_CAN_DATA_MASK7 = 0xFF;	//00	// 8th byte on the bus; if DLC = 8, last byte on the bus
