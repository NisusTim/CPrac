...
extern void SWT2_Timeout_ISR(void);
/*========================================================================*/
/*	GLOBAL VARIABLES						                              */
/*========================================================================*/
...
(uint32_t) &SWT2_Timeout_ISR, /* Vector #  34 Timeout	Software Watchdog (SWT_2) */
...
(uint32_t) &system_timer_isr, /* Vector # 231 Channel 1	PIT_1 */
