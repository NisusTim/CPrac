...
extern void SWT1_Timeout_ISR(void);
/*========================================================================*/
/*	GLOBAL VARIABLES						                              */
/*========================================================================*/
...
(uint32_t) &SWT1_Timeout_ISR, /* Vector #  33 Timeout	Software Watchdog (SWT_1) */
...
(uint32_t) &system_timer_isr, /* Vector # 230 Channel 0	PIT_1 */
