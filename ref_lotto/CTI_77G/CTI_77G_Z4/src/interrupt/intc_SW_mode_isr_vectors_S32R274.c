...
#if (UART_CONSLE == ENABLE)
extern void Transmit_Complete_ISR(void);
extern void Receive_Complete_ISR(void);
#endif
extern void spt_irq0(void);
extern void spt_irq1(void);
extern void spt_ecs_isr(void);
extern void spt_dma_isr(void);
extern void system_timer_isr(void);
extern void ENET_TX_BUFFER_ISR(void);
extern void ENET_RX_BUFFER_ISR(void);
extern void ENET_EVENT_ISR(void);
#ifdef USING_CUBTEK_CAN_0
extern void CAN_0_Bus_Off_Rec_InterruptHandler(void);
extern void CAN_0_Transmit_InterruptHandler(void);
extern void CAN_0_Transmit_InterruptHandler_531(void);
extern void CAN_0_Receive_InterruptHandler(void);
#endif
...
#endif
extern void CAN_2_Transmit_InterruptHandler(void);
extern void CAN_2_Transmit_InterruptHandler_557(void);
extern void CAN_2_Receive_InterruptHandler(void);
extern void FCCU_alarm_isr(void);
extern void FCCU_misc_isr(void);
#ifdef ENABLE_BSW_UDS_NM
extern void custom_timer_isr(void);
#endif
...
(uint32_t) &flash_isr, /* Vector # 185 Prog/Erase/Suspend IRQ	Pflash  */
...
(uint32_t) &ENET_TX_BUFFER_ISR, /* Vector # 217 TX_BUFFER |TX_FRAME	ENET_0 */
(uint32_t) &ENET_RX_BUFFER_ISR, /* Vector # 218 RX_BUFFER |RX_FRAME	ENET_0 */
(uint32_t) &ENET_EVENT_ISR, /* Vector # 219 "WAKE_SYNC | WAKE_ASYNC | */
                   /*              RX_ERR | TX_UNDER | */
...
(uint32_t) &system_timer_isr, /* Vector # 226 Channel 0	PIT_0 */
#ifdef ENABLE_BSW_UDS_NM
(uint32_t) &custom_timer_isr, /* Vector # 227 Channel 1	PIT_0 */
#else
...
#if (UART_CONSLE == ENABLE)
(uint32_t) &Receive_Complete_ISR, /* Vector # 380 LINFlex_RXI LINFlex_1 */
(uint32_t) &Transmit_Complete_ISR, /* Vector # 381 LINFlex_TXI LINFlex_1 */
#else
(uint32_t) &dummy, /* Vector # 380 */
(uint32_t) &dummy, /* Vector # 381 */
#endif
...
(uint32_t) &i2c1_Isr, /* Vector # 442 IRQ_0	IIC_1 */
...
(uint32_t) &FCCU_alarm_isr, /*FCCU_alarm_isr,  Vector # 488 irq_alarm_b	FCCU */
(uint32_t) &FCCU_misc_isr, /*FCCU_misc_isr,  Vector # 489 irq_misc_b	FCCU */
...
#ifdef USING_CUBTEK_CAN_0
(uint32_t) &CAN_0_Bus_Off_Rec_InterruptHandler, /* Vector # 521 FLEXCAN_ESR_BOFF | FLEXCAN_Transmit_Warning | FLEXCAN_Receive_Warning	FlexCAN_0 */
(uint32_t) &CAN_0_Receive_InterruptHandler, /* Vector # 522 FLEXCAN_BUF_00_03	FlexCAN_0 */
(uint32_t) &CAN_0_Receive_InterruptHandler, /* Vector # 523 FLEXCAN_BUF_04_07	FlexCAN_0 */
(uint32_t) &CAN_0_Receive_InterruptHandler, /* Vector # 524 FLEXCAN_BUF_08_11	FlexCAN_0 */
(uint32_t) &CAN_0_Transmit_InterruptHandler, /* Vector # 525 FLEXCAN_BUF_12_15	FlexCAN_0 */
...
(uint32_t) &CAN_0_Transmit_InterruptHandler_531, /* Vector # 531 FLEXCAN_BUF_64_79	FlexCAN_0 */
(uint32_t) &dummy, /* Vector # 532 FLEXCAN_BUF_80_95	FlexCAN_0 */
#endif
#ifdef USING_UDS_NM_CAN_0
(uint32_t) &CAN_PHY0_Busoff_ISR, /* Vector # 521 FLEXCAN_ESR_BOFF | FLEXCAN_Transmit_Warning | FLEXCAN_Receive_Warning	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 522 FLEXCAN_BUF_00_03	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 523 FLEXCAN_BUF_04_07	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 524 FLEXCAN_BUF_08_11	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 525 FLEXCAN_BUF_12_15	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 526 FLEXCAN_BUF_16_31	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 527 FLEXCAN_BUF_32_39	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 528 FLEXCAN_BUF_40_47	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 529 FLEXCAN_BUF_48_55	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 530 FLEXCAN_BUF_56_63	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 531 FLEXCAN_BUF_64_79	FlexCAN_0 */
(uint32_t) &CAN_PHY0_MB_ISR, /* Vector # 532 FLEXCAN_BUF_80_95	FlexCAN_0 */
#endif
...
(uint32_t) &CAN_2_Receive_InterruptHandler, /* Vector # 548 FLEXCAN_BUF_00_03	FlexCAN_2 */
(uint32_t) &CAN_2_Receive_InterruptHandler, /* Vector # 549 FLEXCAN_BUF_04_07	FlexCAN_2 */
(uint32_t) &CAN_2_Receive_InterruptHandler, /* Vector # 550 FLEXCAN_BUF_08_11	FlexCAN_2 */
(uint32_t) &CAN_2_Transmit_InterruptHandler, /* Vector # 551 FLEXCAN_BUF_12_15	FlexCAN_2 */
...
(uint32_t) &CAN_2_Transmit_InterruptHandler_557, /* Vector # 557 FLEXCAN_BUF_64_79	FlexCan_2 */
...
(uint32_t) &spt_irq0, /* Vector # 734 IRQ0	SPT */
(uint32_t) &spt_irq1, /* Vector # 735 IRQ1	SPT */
(uint32_t) &spt_ecs_isr, /* Vector # 736 ECS	SPT */
(uint32_t) &spt_dma_isr, /* Vector # 737 DMA	SPT */
