...
#define  DCM_POWERONSECURITYACCESSDELAY                             STD_OFF
/*SecurityAcessAttempNumber provided by app*/
#define  DCM_SECACCESSNUMPROVIDEDBYAPP                              STD_ON
/*PowerOn security access delay only when last delay not finish*/
#define  DCM_POWERONDELAYLASTDELAYNOTFINISH                         STD_ON
...
extern VAR(Dcm_MsgContextType, DCM_NOINIT_DATA)  gMsgContextBackup;
