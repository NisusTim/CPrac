...
/* L90: */
			    ...
			    if (nounit) {
				R_CNJG(&q__2, &a[i__ + i__ * a_dim1]);   //r_cnjg(&q__2, &a[i__ + i__ * a_dim1]);
			    ...
			    i__2 = i__ - 1;
			    for (k = 1; k <= i__2; ++k) {
				R_CNJG(&q__3, &a[k + i__ * a_dim1]);  //r_cnjg(&q__3, &a[k + i__ * a_dim1]);
				i__3 = k + j * b_dim1;
				q__2.r = q__3.r * b[i__3].r - q__3.i * b[i__3].i;
				q__2.i = q__3.r * b[i__3].i + q__3.i * b[i__3].r;
...
/*           Form  B := alpha*B*A'   or   B := alpha*B*conjg( A' ). */
		...
		for (k = 1; k <= i__1; ++k) {
			...
			if (a[i__3].r != 0.f || a[i__3].i != 0.f) {
				...
				R_CNJG(&q__2, &a[j + k * a_dim1]);  //r_cnjg(&q__2, &a[j + k * a_dim1]);
...
/* L260: */
			...
			if (noconj) {
			    ...
			    R_CNJG(&q__2, &a[k + k * a_dim1]);  //r_cnjg(&q__2, &a[k + k * a_dim1]);
			    q__1.r = temp.r * q__2.r - temp.i * q__2.i;
				    q__1.i = temp.r * q__2.i + temp.i * q__2.r;
			    temp.r = q__1.r, temp.i = q__1.i;
			}
