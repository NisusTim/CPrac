...
static integer c__1 = 1;
    extern /* Subroutine */ int classq_(integer *, complex *, integer *, real *, real *);
...
/* Computing MAX */
                    c = &a[i__ + j * a_dim1];
//		    r__1 = value, r__2 = SQRT(c->r * c->r + c->i * c->i);
...
/* Computing MAX */
                    c = &a[i__ + j * a_dim1];
//		    r__1 = , r__2 = c_abs(&a[i__ + j * a_dim1]);
		    value = dmax(value, SQRT(c->r * c->r + c->i * c->i));
/* L30: */
		}
/* L40: */
