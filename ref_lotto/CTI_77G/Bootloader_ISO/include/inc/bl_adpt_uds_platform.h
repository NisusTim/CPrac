...
extern bl_ResponseCode_t Adpt_UdsCallBackReadF187(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
/** \brief Callback of reading F18A.*/
extern bl_ResponseCode_t Adpt_UdsCallBackReadF18A(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
/** \brief Callback of reading F197.*/
extern bl_ResponseCode_t Adpt_UdsCallBackReadF197(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
...
extern bl_ResponseCode_t Adpt_UdsCallBackReadF193(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
/** \brief Callback of reading F195.*/
extern bl_ResponseCode_t Adpt_UdsCallBackReadF195(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
...
extern bl_ResponseCode_t Adpt_UdsCallBackReadF18C(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
/** \brief Callback of reading F190.*/
extern bl_ResponseCode_t Adpt_UdsCallBackReadF190(bl_BufferSize_t size,
                                                  bl_Buffer_t *buffer,
                                                  bl_BufferSize_t *respSize);
