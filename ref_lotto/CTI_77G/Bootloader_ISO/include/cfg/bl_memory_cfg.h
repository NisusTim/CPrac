...
#define MEM_MEMORY_0_BASE_ADDRESS   (0x40000000UL)
#define MEM_MEMORY_0_SIZE           (0x60000UL)
...
#define MEM_MEMORY_1_BASE_ADDRESS   (0x00F98000UL)
#define MEM_MEMORY_1_SIZE           (0x00268000UL)
...
#define MEM_MEMORY_2_BASE_ADDRESS   (0x00808000UL)
#define MEM_MEMORY_2_SIZE           (0x00008000UL)
#define MEM_MEMORY_2_OPS            (&gs_MemoryOps[2])
#define MEM_MEMORY_2_OPS_INIT       (&DFlashInit)
#define MEM_MEMORY_2_OPS_DEINIT     (&DFlashDeinit)
