...
/** */
#if ((RTE_FUN_STAY_IN_BOOT == BL_FUN_ON)&&(RTE_FUN_RST_RSP_IN_BT == BL_FUN_ON))
#define RTE_NUMBER_OF_BOOTING_PROCESSOR (3)
#elif((RTE_FUN_STAY_IN_BOOT == BL_FUN_ON)||(RTE_FUN_RST_RSP_IN_BT == BL_FUN_ON))
#define RTE_NUMBER_OF_BOOTING_PROCESSOR (2)
#else
#define RTE_NUMBER_OF_BOOTING_PROCESSOR (1)
#endif
...
#define RTE_PMIC_OPS_INIT				(&FS8x_Init)
#define RTE_PMIC_OPS_FEED				(&FS8x_Feed)
