...
#define SECM_ACCESS_INIT            (&Acc_UdsFawInit)
#define SECM_ACCESS_MAKE_NEWSEED    (&Acc_UdsFawMakeNewSeed)
#define SECM_ACCESS_GET_SEED        (&Acc_UdsFawGetSeed)
#define SECM_ACCESS_VERIFY_KEY      (&Acc_UdsFawVerifyKey)
