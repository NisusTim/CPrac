...
#define DM_NUMBER_OF_MANAGED_DATA   (15)
...
#define DM_DATA_8_LOCAL_ADDR        (0x00808080UL)
...
#define DM_DATA_9_LOCAL_ADDR        (0x00808010UL)
#define DM_DATA_9_SIZE              (10UL)
#define DM_DATA_9_DDP               (BL_NULL_PTR)

/*DID 0xF197*/
#define DM_DATA_10_TYPE              DM_DATA_TYPE_READ_ONLY
#define DM_DATA_10_MEMID             (2)
#define DM_DATA_10_LOCAL_ADDR        (0x00808020UL)
#define DM_DATA_10_SIZE              (10UL)
#define DM_DATA_10_DDP               (BL_NULL_PTR)

/*DID 0xF193*/
#define DM_DATA_11_TYPE              DM_DATA_TYPE_READ_ONLY
#define DM_DATA_11_MEMID             (2)
#define DM_DATA_11_LOCAL_ADDR        (0x00808030UL)
#define DM_DATA_11_SIZE              (15UL)
#define DM_DATA_11_DDP               (BL_NULL_PTR)

/*DID 0xF195*/
#define DM_DATA_12_TYPE              DM_DATA_TYPE_READ_ONLY
#define DM_DATA_12_MEMID             (2)
#define DM_DATA_12_LOCAL_ADDR        (0x00808040UL)
#define DM_DATA_12_SIZE              (15UL)
#define DM_DATA_12_DDP               (BL_NULL_PTR)

/*DID 0xF18C*/
#define DM_DATA_13_TYPE              DM_DATA_TYPE_READ_ONLY
#define DM_DATA_13_MEMID             (2)
#define DM_DATA_13_LOCAL_ADDR        (0x00808050UL)
#define DM_DATA_13_SIZE              (14UL)
#define DM_DATA_13_DDP               (BL_NULL_PTR)

/*DID 0xF190*/
#define DM_DATA_14_TYPE              DM_DATA_TYPE_READ_AND_WRITE
#define DM_DATA_14_MEMID             (2)
#define DM_DATA_14_LOCAL_ADDR        (0x00808060UL)
#define DM_DATA_14_SIZE              (17UL)
#define DM_DATA_14_DDP               (BL_NULL_PTR)
