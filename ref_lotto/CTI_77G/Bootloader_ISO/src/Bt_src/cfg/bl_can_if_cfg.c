...
{
    {
        CANIF_RECEIVE, CANIF_EXTERNED, HANDLE_CAN0_RX0, CANIF_PHY_RX_CANID
    },
    {
        CANIF_RECEIVE, CANIF_EXTERNED, HANDLE_CAN0_RX0, 0x7dfUL
    },
    {
        CANIF_TRANSMITE, CANIF_EXTERNED, HANDLE_CAN0_TX0,CANIF_PHY_TX_CANID
    },
};
#else
static const bl_CanIfPduCfg_t gs_CanIfPduCfg[CANIF_NUMBER_OF_PDU] =
{
    ...
    {
        CANIF_RECEIVE, CANIF_EXTERNED, HANDLE_CAN0_RX0, CANIF_FUN_TX_CANID
    },
    {
        CANIF_TRANSMITE, CANIF_EXTERNED, HANDLE_CAN0_TX0,CANIF_PHY_TX_CANID
    },
